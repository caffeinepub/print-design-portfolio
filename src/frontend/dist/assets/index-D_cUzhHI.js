...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0a] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 md:px-10 pt-10 pb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#F7B818] text-xs font-bold tracking-[0.25em] uppercase", children: "Portfolio" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-[#F7B818]/40" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-3xl md:text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight text-white mb-1", children: "Print Design" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-3xl md:text-4xl lg:text-5xl font-black uppercase leading-none tracking-tight text-[#F7B818] mb-6", children: "Brochures · Menu Cards · Hoardings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/40 tracking-wide max-w-lg", children: "Showcasing print work including brochures, menu cards, and hoardings." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-7xl mx-auto px-6 md:px-10 pb-16 flex flex-col gap-4", children: [
      rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4", children: row.images.map((image) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full rounded-xl overflow-hidden border border-white/15 bg-[#111] transition-transform duration-300 ease-in-out hover:scale-[1.04]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: flex4.src,
          alt: flex4.alt,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-[#F7B818]/20 py-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-white/30 tracking-wider", children: [
      "© ",
